				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="#" class="dropdown-toggle">
							...
							<span class="menu-text"> Chai Sacco Branches </span>
				...
				<div class="page-content">
					...
					<div class="page-content-area">
						<div class="page-header">
								...
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">My Loan Statement</h3>
										<div class="table-header">
											Results for "My Running Loan Transactions"
										</div>
										...
										<div>
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<c:forEach items="${listLoanAccountTransaction}" var="transaction">
													<tr> <!-- Start Here -->
														<td class="center">
															<label class="position-relative">
																<input type="checkbox" class="ace" />
														...
														<c:out value="${transaction.dbAmount}" />
														</c:when>
														</c:choose>
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">Chai-sacco</span>
							Portal &copy; 2014-2015
						</span>
